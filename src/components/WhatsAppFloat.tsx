...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="wa-float group fixed right-4 bottom-24 z-40 grid size-14 place-items-center rounded-full border-2 border-gold/70 bg-forest text-primary-foreground shadow-lift transition-transform duration-300 hover:scale-110 md:right-6 md:bottom-8 md:size-16"
    >
